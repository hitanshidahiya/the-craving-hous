    ...
    <footer className="bg-ch-brown relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 pt-16 pb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              {['Burgers', 'Pasta', 'Frappes','Desserts', 'Combos'].map(item => (
                <li key={item}>
                  <Link to="/menu" className="text-ch-cream/40 text-sm hover:text-ch-cream transition-colors duration-200">
                    {item}
                  </Link>
                </li>
              ))}
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              {[['Home', '/'], ['Menu', '/menu'], ['Track Order', '/track'], ['Admin', '/admin']].map(([label, to]) => (
                <li key={label}>
                  <Link to={to} className="text-ch-cream/40 text-sm hover:text-ch-cream transition-colors duration-200">
                    {label}
                  </Link>
                </li>
              ))}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-ch-cream/25 text-xs">
            © 2026 The Craving Hous · All rights reserved
          </p>
