...
//         <div className="absolute bottom-16 left-4 z-10 flex gap-3 sm:gap-4 animate-fade-up sm:bottom-16 sm:left-12 lg:left-24">
//           <Link
  ...
  return (
    <>
      ...
      <section className="relative min-h-[70vh] sm:min-h-screen flex flex-col justify-center items-center overflow-hidden">
        ...
        {/* ── MOBILE: buttons + stats pinned to bottom ── */}
        <div className="absolute bottom-0 left-0 right-0 z-10 flex flex-col px-4 pb-5 gap-4 sm:hidden">
          <div className="flex gap-3">
            <Link to="/order?type=dine-in"
              className="inline-flex items-center gap-2 font-semibold text-[12px] px-5 py-3 rounded-full transition-all duration-200 active:scale-95"
              style={{ background: '#C8972A', color: '#1A0A04' }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M3 2h18l-2 13H5L3 2z" /><circle cx="9" cy="21" r="1" /><circle cx="15" cy="21" r="1" />
              </svg>
          ...
          <div className="flex w-full border-t border-ch-cream/15 pt-3">
            {[
              { val: '5.0 ★', label: 'GOOGLE RATING' },
              { val: '19+', label: 'HAPPY REVIEWS' },
              { val: '₹1–200', label: 'AFFORDABLE' },
              ...
              <div key={i} className="flex-1">
                <p className="font-display font-bold text-ch-cream text-sm leading-none">{s.val}</p>
                <p className="text-ch-cream/40 text-[9px] tracking-widest mt-1">{s.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* ── DESKTOP: buttons ── */}
        <div className="hidden sm:flex gap-4 absolute bottom-20 left-12 lg:left-24 z-10 animate-fade-up">
          <Link to="/order?type=dine-in"
            className="inline-flex items-center gap-2 font-semibold text-[13px] px-7 py-3.5 rounded-full
              transition-all duration-200 hover:scale-105 hover:shadow-[0_6px_24px_rgba(200,151,42,0.45)]"
            style={{ background: '#C8972A', color: '#1A0A04' }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M3 2h18l-2 13H5L3 2z" /><circle cx="9" cy="21" r="1" /><circle cx="15" cy="21" r="1" />
        ...
        {/* ── DESKTOP: stats ── */}
        <div className="hidden sm:flex absolute bottom-0 left-0 z-10 w-full border-t border-ch-cream/10">
          <div className="flex max-w-sm ml-12 lg:ml-24">
            {[
              { val: '5.0 ★', label: 'GOOGLE RATING' },
              { val: '19+', label: 'HAPPY REVIEWS' },
              { val: '₹1–200', label: 'AFFORDABLE' },
     ...
     <section className="hidden sm:block py-14 sm:py-24 bg-ch-brown relative overflow-hidden">
      ...
      <section id="gallery" className="py-14 sm:py-24 bg-ch-parchment">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          {/* Mobile: stacked with overlays */}
          <div className="flex flex-col gap-3 sm:hidden">
            <div className="rounded-[16px] overflow-hidden relative aspect-[4/3]">
              <img src={interior2} alt="Interior" className="w-full h-full object-cover object-center" />
              <div className="absolute inset-0 bg-gradient-to-t from-ch-brown/70 via-transparent to-transparent flex items-end p-4">
                <div>
                  <p className="font-display text-ch-cream font-semibold text-sm">Cozy Interiors</p>
                  <p className="text-ch-cream/60 text-[11px]">Rattan lights · Walnut wood · Warm ambience</p>
            ...
            {[
              { src: interior1, label: 'Logo Wall', sub: 'Our signature mirror sign', pos: 'object-top' },
              { src: food1, label: 'Delicious Food', sub: 'Made fresh every day', pos: 'object-center' },
            ].map((g) => (
              <div key={g.label} className="rounded-[16px] overflow-hidden relative aspect-[4/3]">
                <img src={g.src} alt={g.label} className={`w-full h-full object-cover ${g.pos}`} />
                <div className="absolute inset-0 bg-gradient-to-t from-ch-brown/70 via-transparent to-transparent flex items-end p-4">
                  <div>
                    <p className="font-display text-ch-cream font-semibold text-sm">{g.label}</p>
                    <p className="text-ch-cream/55 text-[11px]">{g.sub}</p>
