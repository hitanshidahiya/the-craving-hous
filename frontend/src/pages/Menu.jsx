...
// //         {/* price pill on image */}
// //         <div className="absolute bottom-2.5 right-2.5 bg-black/30 backdrop-blur-sm text-white text-[11px] font-bold px-2 py-0.5 rounded-full">
// //           ₹{item.price}
// //         </div>
...
// //             text-[9px] font-semibold px-2 py-0.5 rounded-full tracking-wider">⭐ Best Seller</span>
// //         )}
// //         {!item.best && item.hot && (
// //           <span className="absolute top-2.5 left-2.5 bg-ch-gold/80 backdrop-blur-sm text-ch-brown
// //             text-[9px] font-semibold px-2 py-0.5 rounded-full tracking-wider">🔥 Trending</span>
// //         )}
// //       </div>
...
// //             <span className="text-ch-amber text-sm font-bold">
